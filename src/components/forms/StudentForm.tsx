...
const schema = z.object({
  ...
  birthday: z.union([
    z.date().min(new Date(1900, 1, 1), { message: "Invalid birthday!" }).max(new Date(), { message: "Invalid birthday!" }),
    ...
    <form className="flex flex-col gap-8 p-4" onSubmit={onSubmit}>
      ...
      <div className="flex justify-between flex-wrap gap-8">
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.bloodType?.message && <p className="text-red-400 text-xs">{errors.bloodType.message.toString()}</p>}
        </div>
        {/* Birthday */}
        <InputField
          label="Birthday"
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          {errors.gender?.message && <p className="text-red-400 text-xs">{errors.gender.message.toString()}</p>}
        </div>
        ...
        <div className="flex flex-col gap-2 w-full md:w-1/4">
          ...
          <input
            ...
            id="avatar"
            {...register("avatar")} />
          {errors.avatar?.message && <p className="text-red-400 text-xs">{errors.avatar.message.toString()}</p>}
        </div>
      </div>
